...
namespace Sky.Tests.Features.Blogs
{
    ...
    public class BlogControllerBlogPostTests : SkyCmsTestBase
    {
        ...
        /// <summary>
        /// Tests that EditEntry successfully updates a blog post with the new UpdateBlogPostCommand.
        /// </summary>
        [TestMethod]
        public async Task EditEntry_SucceedsWithValidData()
        {
            // Arrange - Create a blog post first
            var createResult = await controller.CreateEntry(blogStream.BlogKey, "Original Title");
            ...
            var updateModel = new BlogEntryEditViewModel
            {
                ...
                BannerImage = "/updated-image.jpg",
                Published = null,
                PublishNow = false
            };

            // Act
            var result = await controller.EditEntry(blogStream.BlogKey, articleNumber, updateModel);
            ...
            Assert.AreEqual("Updated intro", updatedPost.Introduction);
        }

        /// <summary>
        /// Tests that EditEntry increments the version number on update.
        /// </summary>
        [TestMethod]
        ...
        {
            // Arrange - Create a blog post
            var createResult = await controller.CreateEntry(blogStream.BlogKey, "URL Test");
            var redirect = (RedirectToActionResult)createResult;
            var articleNumber = (int)redirect.RouteValues["id"];
        ...
        /// <summary>
        /// Tests that EditEntry returns NotFound when blog post doesn't exist.
        /// </summary>
        [TestMethod]
        public async Task EditEntry_ReturnsNotFound_WhenPostDoesNotExist()
        {
            // Arrange
            ...
            {
                BlogKey = blogStream.BlogKey,
                ArticleNumber = nonExistentArticleNumber,
                Title = "Test",
                Content = "Test"
            };

            // Act
            var result = await controller.EditEntry(blogStream.BlogKey, nonExistentArticleNumber, model);
        ...
        /// <summary>
        /// Tests the complete lifecycle of a blog post: create, edit, delete.
        /// </summary>
        [TestMethod]
        public async Task CompleteLifecycle_CreateEditDelete_BlogPost()
        {
            // Arrange & Act - Create
            var createResult = await controller.CreateEntry(blogStream.BlogKey, "Lifecycle Test");
