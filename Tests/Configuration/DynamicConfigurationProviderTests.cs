...
namespace Sky.Tests.Configuration
{
    using System;
    ...
    public class DynamicConfigurationProviderTests : SkyCmsTestBase
    {
        ...
        public async Task ValidateDomainName_NoConfigDbConnectionString_ThrowsArgumentException()
        {
            ...
            mockConfig.Setup(x => x.GetConnectionString("ConfigDbConnectionString")).Returns((string?)null);
            mockConfig.Setup(x => x.GetValue<bool?>("MultiTenant", It.IsAny<bool?>())).Returns(false);
