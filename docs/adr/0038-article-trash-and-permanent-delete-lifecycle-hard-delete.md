...
(`FileEntryTitleService.FilterDeletedArticleEntriesAsync`), and established this
...
`FileEntryTitleService.FilterDeletedArticleEntriesAsync` for this purpose — do
...
- Shared path helper:
  - `Editor/Services/FileEntryPathHelper.cs` — `ExtractArticleNumbersFromEntries`
